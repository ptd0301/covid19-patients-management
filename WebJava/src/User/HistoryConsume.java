 ...
 * @author Admin
 */
public class HistoryConsume extends javax.swing.JFrame {

    /**
     * Creates new form HistoryManage
     */
    public HistoryConsume() {
        initComponents();
        ...
        jButtonback.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                HistoryConsume.this.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Lịch sử tiêu thụ sản phẩm");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ngày", "Tên sản phẩm", "Số lượng tiêu thụ"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryConsume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryConsume().setVisible(true);
            }
        });
    }
