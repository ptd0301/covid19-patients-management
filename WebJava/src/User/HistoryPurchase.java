 ...
 * @author Admin
 */
public class HistoryPurchase extends javax.swing.JFrame {

    /**
     * Creates new form HistoryManage
     */
    public HistoryPurchase() {
        ...
        jButtonback.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                HistoryPurchase.this.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Lịch sử mua hàng");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ngày", "Tên sản phẩm", "Đơn giá", "Số lượng", "Thành tiền"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryPurchase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryPurchase().setVisible(true);
            }
        });
    }
