 ...
 * @author Admin
 */
public class Historymanage extends javax.swing.JFrame {
    ...
    public Historymanage() {
        ...
        jButtonback.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Historymanage.this.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Lịch sử quá trình được quản lý");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ngày", "Mã bệnh nhân", "Trạng thái hiện tại", "Nơi đang điều trị"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Historymanage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Historymanage().setVisible(true);
            }
        });
    }
