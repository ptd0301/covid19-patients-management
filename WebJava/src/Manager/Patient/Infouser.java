...
public class Infouser extends javax.swing.JFrame {
    ...
    public Infouser() {
                ...
                if(!jTextField3.getText().equals("Họ tên") && !jTextField4.getText().equals("Năm sinh") &&
                   ...
                   !jTextField11.getText().equals("Nơi đang điều trị/cách ly")) {
                    ...
                    try {
                        ...
                        String sql = "update history_process set statuss = ?, idPlace = ? where idPatient = ?";
                        ...
                        JOptionPane.showMessageDialog(Infouser.this, ex);
                    }
        ...
        jButton4.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Historymanage fram2 = new Historymanage();
                fram2.setVisible(true);
                Infouser.this.setVisible(false);
            }
        });
        jButton5.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Historypurchase fram2 = new Historypurchase();
                fram2.setVisible(true);
                Infouser.this.setVisible(false);
            }
        });
        jButton6.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Historyconsume fram2 = new Historyconsume();
                fram2.setVisible(true);
                Infouser.this.setVisible(false);
            }
        });
        jButton7.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ListInvolve fram2 = new ListInvolve();
                fram2.setVisible(true);
                Infouser.this.setVisible(false);
            }
        });
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Thông tin người liên quan covid");
        ...
        jLabel7.setText("Nơi đang điều trị / cách ly: ");
        ...
        jLabel8.setText("  Lịch sử quá trình được quản lý:");

        jButton4.setText("Xem lịch sử");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_order_history_20px.png"))); // NOI18N
        jLabel9.setText("  Lịch sử thanh toán:");

        jButton5.setText("Xem lịch sử");

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_order_history_20px.png"))); // NOI18N
        jLabel10.setText("  Lịch sử tiêu thụ:");

        jButton6.setText("Xem lịch sử");

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_order_history_20px.png"))); // NOI18N
        jLabel11.setText("Danh sách người liên đới:");

        jButton7.setText("Xem danh sách");
