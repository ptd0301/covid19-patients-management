...
public class Addproduct extends javax.swing.JFrame {
    ...
    public Addproduct() {
        ...
        jTextField3.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField3.getText().isEmpty()) {
                    jTextField3.setForeground(Color.BLACK);
                    jTextField3.setText("Tên nhu yếu phẩm");
                }
            }
        });
        ...
        jTextField5.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField5.getText().isEmpty()) {
                    jTextField5.setForeground(Color.BLACK);
                    jTextField5.setText("Đơn vị tính");
                }
            }
        });
        ...
        jTextField7.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField7.getText().isEmpty()) {
                    jTextField7.setForeground(Color.BLACK);
                    jTextField7.setText("Mã nhu yếu phẩm");
                }
            }
        });
        ...
        jButtonconfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextField3.getText().equals("Tên nhu yếu phẩm")) {
                ...
                if (jTextField5.getText().equals("Đơn vị tính")) {
                ...
                if (jTextField7.getText().equals("Mã nhu yếu phẩm")) {
                    Valid4.setForeground(Color.RED);
                }
                if (!jTextField7.getText().equals("Mã nhu yếu phẩm")) {
                    Valid4.setForeground(Color.WHITE);
                ...
                if(!jTextField3.getText().equals("Tên nhu yếu phẩm") && !jTextField4.getText().equals("Hình ảnh") &&
                   !jTextField5.getText().equals("Đơn vị tính") && !jTextField6.getText().equals("Đơn giá") &&
                   !jTextField7.getText().equals("Mã nhu yếu phẩm")) {
                    ...
                    try {
                        ...
                        String sql = "insert into supply values(?,?,null,?,?,?)";
                        ...
                        JOptionPane.showMessageDialog(Addproduct.this, ex);
                    }
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Thêm nhu yếu phẩm");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_currency_settings_20px.png"))); // NOI18N
        ...
        Valid3.setText("Hãy nhập đơn vị tính");
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_orcid_20px.png"))); // NOI18N
        ...
        Valid5.setText("Hãy nhập mã nhu yếu phẩm");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(Valid3, javax.swing.GroupLayout.DEFAULT_SIZE, 536, Short.MAX_VALUE))
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jTextField5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextField7, javax.swing.GroupLayout.PREFERRED_SIZE, 547, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
