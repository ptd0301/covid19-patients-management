 ...
 * @author Admin
 */
public class Delpacket extends javax.swing.JFrame {

    /**
     * Creates new form Delpacket
     */
    public Delpacket() {
        initComponents();
        ...
        jTextField3.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField3.getText().isEmpty()) {
                    jTextField3.setForeground(Color.LIGHT_GRAY);
                    jTextField3.setText("Mã gói nhu yếu phẩm cần xóa");
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {                
                if (jTextField3.getText().length() == 8) {
                    try {
                        ...
                        String sql1 = "select * from packet_supply where idPacket = ?";
                        ps = conn.prepareStatement(sql1);
                        ps.setString(1, jTextField3.getText());
                        ResultSet rs = ps.executeQuery();
                        if (rs.next()) {
                            String sql = "delete from packet_supply where idPacket = ?";
                            ps = conn.prepareStatement(sql);
                            ps.setString(1, jTextField3.getText());
                            ps.executeUpdate();
                            DS_Packet fram1 = new DS_Packet();
                            fram1.setVisible(true);
                            Delpacket.this.setVisible(false);
                        }
                        else {
                            Valid1.setForeground(Color.RED);
                        }
                    } catch(Exception ex) {
                        JOptionPane.showMessageDialog(Delpacket.this, ex);
                    }
                }
                else {
                    Valid1.setForeground(Color.RED);
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Xóa gói nhu yếu phẩm");
        ...
        jLabel2.setText("Nhập mã gói nhu yếu phẩm cần xóa:");

        jTextField3.setForeground(new java.awt.Color(102, 102, 102));
        jTextField3.setText("Mã gói nhu yếu phẩm cần xóa");

        Valid1.setText("Mã gói nhu yếu phẩm không hợp lệ");
