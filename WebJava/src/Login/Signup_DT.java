 ...
 * @author Admin
 */
public class Signup_DT extends javax.swing.JFrame {

    /**
     * Creates new form Signup_DT
     */
    public Signup_DT() {
        initComponents();
        ...
        jTextField1.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField1.getText().isEmpty()) {
                    jTextField1.setForeground(Color.GRAY);
                    jTextField1.setText("Tên đối tác");
                }
            }
        });
        ...
        jTextField2.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField2.getText().isEmpty()) {
                    jTextField2.setForeground(Color.GRAY);
                    jTextField2.setText("Tên người đại diện");
                }
            }
        });
        ...
        jTextField3.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField3.getText().isEmpty()) {
                    jTextField3.setForeground(Color.GRAY);
                    jTextField3.setText("Địa chỉ doanh nghiệp");
                }
            }
        });
        ...
        jTextField9.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField9.getText().isEmpty()) {
                    jTextField9.setForeground(Color.GRAY);
                    jTextField9.setText("Số lượng chi nhánh");
                }
            }
        });
        ...
        jTextField10.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField10.getText().isEmpty()) {
                    jTextField10.setForeground(Color.GRAY);
                    jTextField10.setText("Số đơn hàng / ngày");
                }
            }
        });
        ...
        jTextField11.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField11.getText().isEmpty()) {
                    jTextField11.setForeground(Color.GRAY);
                    jTextField11.setText("Loại hàng hóa");
                }
            }
        });
        ...
        jButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextField1.getText().equals("Tên đối tác")) {
                    Valid1.setForeground(Color.RED);
                }
                if (!jTextField1.getText().equals("Tên đối tác")) {
                    Valid1.setForeground(Color.WHITE);
                }
                if (jTextField2.getText().equals("Tên người đại diện")) {
                    Valid2.setForeground(Color.RED);
                }
                if (!jTextField2.getText().equals("Tên người đại diện")) {
                    Valid2.setForeground(Color.WHITE);
                }
                if (jTextField3.getText().equals("Địa chỉ doanh nghiệp")) {
                ...
                if (jTextField9.getText().equals("Số lượng chi nhánh")) {
                    Valid9.setForeground(Color.RED);
                }
                if (!jTextField9.getText().equals("Số lượng chi nhánh")) {
                    Valid9.setForeground(Color.WHITE);
                }
                if (jTextField10.getText().equals("Số đơn hàng / ngày")) {
                    Valid10.setForeground(Color.RED);
                }
                if (!jTextField10.getText().equals("Số đơn hàng / ngày")) {
                    Valid10.setForeground(Color.WHITE);
                }
                if (jTextField11.getText().equals("Loại hàng hóa")) {
                ...
                if(!jTextField1.getText().equals("Tên đối tác") && !jTextField2.getText().equals("Tên người đại diện") &&
                   !jTextField3.getText().equals("Địa chỉ doanh nghiệp") && !jTextField4.getText().equals("Quận") &&
                   ...
                   !jTextField9.getText().equals("Số lượng chi nhánh") && !jTextField10.getText().equals("Số đơn hàng / ngày") &&
                   !jTextField11.getText().equals("Loại hàng hóa")) {
                    Signup fram = new Signup();
                    fram.setVisible(true);
                    Signup_DT.this.setVisible(false);
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_company_20px.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_repository_20px.png"))); // NOI18N
        jLabel6.setText("jLabel6");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_order_history_20px.png"))); // NOI18N
        jLabel7.setText("jLabel7");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8_shopping_cart_20px.png"))); // NOI18N
        jLabel8.setText("jLabel8");

        jButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jButton.setText("NEXT");

        Valid1.setText("Hãy nhập tên đối tác");

        Valid2.setText("Hãy nhập tên người đại diện");

        Valid3.setText("Hãy nhập địa chỉ doanh nghiệp");
        ...
        Valid9.setText("Hãy nhập số lượng chi nhánh");

        Valid10.setText("Hãy nhập số lượng đơn hàng / ngày");

        Valid11.setText("Hãy nhập loại hàng hóa");
