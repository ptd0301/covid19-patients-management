 ...
 * @author Admin
 */
public class Signup_KH extends javax.swing.JFrame {

    /**
     * Creates new form Signup_KH
     */
    public Signup_KH() {
        initComponents();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!jTextField1.getText().equals("Họ và Tên") &&
                   ...
                   !jTextField6.getText().equals("Số điện thoại") && !jTextField7.getText().equals("Địa chỉ email")) {
                    ...
                    Signup_KH.this.setVisible(false);
                }
            }     
        });
    }          
    ...
    private void initComponents() {
        ...
        role.setText("Vai trò:  Khách hàng");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Container, javax.swing.GroupLayout.PREFERRED_SIZE, 499, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
