 ...
 * @author Admin
 */
public class DelHospital extends javax.swing.JFrame {
        ...
        jTextField3.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                if (jTextField3.getText().isEmpty()) {
                    jTextField3.setForeground(Color.LIGHT_GRAY);
                    jTextField3.setText("Tên nơi điều trị / cách ly cần xóa");
                }
            }
        });
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTextField3.getText().length() == 8) {
                    try {
                        ...
                        String sql1 = "select * from place_of_statement where idPlace = ?";
                        ps = conn.prepareStatement(sql1);
                        ps.setString(1, jTextField3.getText());
                        ResultSet rs = ps.executeQuery();
                        if (rs.next()) {
                            String sql = "delete from place_of_statement where idPlace = ?";
                            ps = conn.prepareStatement(sql);
                            ps.setString(1, jTextField3.getText());
                            ps.executeUpdate();
                            ListHospital fram1 = new ListHospital();
                            fram1.setVisible(true);
                            DelHospital.this.setVisible(false);
                        }
                        else {
                            Valid1.setForeground(Color.RED);
                        }
                    } catch(Exception ex) {
                        JOptionPane.showMessageDialog(DelHospital.this, ex);
                    }
                }
                else {
                    Valid1.setForeground(Color.RED);
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Xóa nơi điều trị / cách ly");
        ...
        jLabel2.setText("Nhập mã nơi điều trị / cách ly cần xóa:");

        jTextField3.setForeground(new java.awt.Color(102, 102, 102));
        jTextField3.setText("Mã nơi điều trị / cách ly cần xóa");

        Valid1.setText("Mã nơi điều trị / cách ly không hợp lệ");
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel4Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(Valid1, javax.swing.GroupLayout.PREFERRED_SIZE, 276, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelHospital.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelHospital().setVisible(true);
            }
        });
    }
