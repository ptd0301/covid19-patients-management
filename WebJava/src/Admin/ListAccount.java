...
public class ListAccount extends javax.swing.JFrame {
    ...
    public ListAccount() {
        ...
        jButtonAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                AddAccount fram1 = new AddAccount();
                fram1.setVisible(true);
                ListAccount.this.setVisible(false);
            }
        });
        ...
        jButtonDel.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                DelAccount fram2 = new DelAccount();
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Danh sách tài khoản");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên tài khoản", "Mật khẩu", "Phân quyền", "Trạng thái"
            }
        ));
